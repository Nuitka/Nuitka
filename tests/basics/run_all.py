...
for filename in sorted( os.listdir( "." ) ):
    ...
    if active:
        ...
        if use_python == "python3.2" and filename[:-3] in ( "Builtins", "Classes", "ExceptionRaising", "ExecEval", "Functions", "GlobalStatement", "Inspection", "Looping", "OverflowFunctions", "ParameterErrors", "Unicode", ):
