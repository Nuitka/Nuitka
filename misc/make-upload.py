...
assert 0 == os.system( "scp README.pdf README.html Developer_Manual.pdf Developer_Manual.html doc/man-nuitka.html doc/man-nuitka-python.html root@nuitka.net:/var/www/doc/" )
