...
from .BuiltinCodes import (
    ...
    generateBuiltinSumXrange1Code,
    generateBuiltinSumXrange2Code,
    generateBuiltinSumXrange3Code,
...
addExpressionDispatchDict(
    {
        ...
        "EXPRESSION_BUILTIN_SUM_XRANGE1": generateBuiltinSumXrange1Code,
        "EXPRESSION_BUILTIN_SUM_XRANGE2": generateBuiltinSumXrange2Code,
        "EXPRESSION_BUILTIN_SUM_XRANGE3": generateBuiltinSumXrange3Code,
