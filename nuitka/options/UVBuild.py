...
"""
This module handles the extraction of build configuration from uv_build projects.
"""
...
def getUVBuildConfiguration(logger):
    """
    Get the build configuration from a uv_build project.
    """
    # This is "uv_build" handling.
    with withTemporaryDirectory("nuitka-project-dump") as temp_dir:
        dump_filename = os.path.join(temp_dir, "build_config.json")

        # Locate the script "misc/extract-uv-build-config.py" relative to this module.
