...
static PyObject *SLOT_nb_or_OBJECT_LONG_LONG(PyObject *operand1, PyObject *operand2) {
...
static PyObject *_BINARY_OPERATION_BITOR_OBJECT_LONG_LONG(PyObject *operand1, PyObject *operand2) {
    ...
    return SLOT_nb_or_OBJECT_LONG_LONG(operand1, operand2);
}
...
static nuitka_bool SLOT_nb_or_NBOOL_LONG_LONG(PyObject *operand1, PyObject *operand2) {
    PyObject *x = PyLong_Type.tp_as_number->nb_or(operand1, operand2);
    assert(x != Py_NotImplemented);
    if (unlikely(x == NULL)) {
...
static nuitka_bool _BINARY_OPERATION_BITOR_NBOOL_LONG_LONG(PyObject *operand1, PyObject *operand2) {
    ...
    return SLOT_nb_or_NBOOL_LONG_LONG(operand1, operand2);
}
...
#if PYTHON_VERSION < 300
static PyObject *SLOT_nb_or_OBJECT_INT_INT(PyObject *operand1, PyObject *operand2) {
    CHECK_OBJECT(operand1);
...
static PyObject *_BINARY_OPERATION_BITOR_OBJECT_INT_INT(PyObject *operand1, PyObject *operand2) {
    ...
    return SLOT_nb_or_OBJECT_INT_INT(operand1, operand2);
}
...
#if PYTHON_VERSION < 300
static nuitka_bool SLOT_nb_or_NBOOL_INT_INT(PyObject *operand1, PyObject *operand2) {
    CHECK_OBJECT(operand1);
    assert(PyInt_CheckExact(operand1));
#if PYTHON_VERSION < 300
    assert(NEW_STYLE_NUMBER(operand1));
...
static nuitka_bool _BINARY_OPERATION_BITOR_NBOOL_INT_INT(PyObject *operand1, PyObject *operand2) {
    ...
    return SLOT_nb_or_NBOOL_INT_INT(operand1, operand2);
}
...
static PyObject *SLOT_nb_or_OBJECT_SET_SET(PyObject *operand1, PyObject *operand2) {
...
static PyObject *_BINARY_OPERATION_BITOR_OBJECT_SET_SET(PyObject *operand1, PyObject *operand2) {
    ...
    return SLOT_nb_or_OBJECT_SET_SET(operand1, operand2);
}
