...
static PyObject *SLOT_nb_or_LIST_LIST(PyObject *operand1, PyObject *operand2) {
    PyObject *x = PyList_Type.tp_as_number->nb_or(operand1, operand2);
    assert(x != Py_NotImplemented);
    return x;
}
...
PyObject *BINARY_OPERATION_BITOR_OBJECT_LIST(PyObject *operand1, PyObject *operand2) {
    ...
    if (!(type1 == type2)) {
        ...
        return SLOT_nb_or_LIST_LIST(operand1, operand2);
    }
