...
//
/** For matching values with 3.10 or higher
 *
 *
 **/
...
static bool FORMAT_MATCH_MISMATCH_ERROR(PyTypeObject *type, int max_allowed, int actual) {
...
PyObject *MATCH_CLASS_ARGS(PyObject *matched, int max_allowed) {
    Py_TYPE(matched);
    ...
    int actual = PyTuple_GET_SIZE(match_args);
