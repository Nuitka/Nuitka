...
static inline PyObject *SLOT_nb_subtract_OBJECT_INT_INT(PyObject *operand1, PyObject *operand2) {
    ...
    }
    {
        ...
        PyObject *o = PyLong_Type.tp_as_number->nb_subtract(op1, op2);
...
static PyObject *_BINARY_OPERATION_SUB_OBJECT_INT_INT(PyObject *operand1, PyObject *operand2) {
    ...
    return SLOT_nb_subtract_OBJECT_INT_INT(operand1, operand2);
}
...
#if PYTHON_VERSION < 0x300
static inline nuitka_bool SLOT_nb_subtract_NBOOL_INT_INT(PyObject *operand1, PyObject *operand2) {
    CHECK_OBJECT(operand1);
    assert(PyInt_CheckExact(operand1));
#if PYTHON_VERSION < 0x300
    assert(NEW_STYLE_NUMBER(operand1));
...
static nuitka_bool _BINARY_OPERATION_SUB_NBOOL_INT_INT(PyObject *operand1, PyObject *operand2) {
    ...
    return SLOT_nb_subtract_NBOOL_INT_INT(operand1, operand2);
}
...
static PyObject *SLOT_nb_subtract_OBJECT_LONG_LONG(PyObject *operand1, PyObject *operand2) {
...
static PyObject *_BINARY_OPERATION_SUB_OBJECT_LONG_LONG(PyObject *operand1, PyObject *operand2) {
    ...
    return SLOT_nb_subtract_OBJECT_LONG_LONG(operand1, operand2);
}
...
static nuitka_bool SLOT_nb_subtract_NBOOL_LONG_LONG(PyObject *operand1, PyObject *operand2) {
    PyObject *x = PyLong_Type.tp_as_number->nb_subtract(operand1, operand2);
    assert(x != Py_NotImplemented);
    if (unlikely(x == NULL)) {
        return NUITKA_BOOL_EXCEPTION;
...
static nuitka_bool _BINARY_OPERATION_SUB_NBOOL_LONG_LONG(PyObject *operand1, PyObject *operand2) {
    ...
    return SLOT_nb_subtract_NBOOL_LONG_LONG(operand1, operand2);
}
...
static PyObject *SLOT_nb_subtract_OBJECT_FLOAT_FLOAT(PyObject *operand1, PyObject *operand2) {
    CHECK_OBJECT(operand1);
...
static PyObject *_BINARY_OPERATION_SUB_OBJECT_FLOAT_FLOAT(PyObject *operand1, PyObject *operand2) {
    ...
    return SLOT_nb_subtract_OBJECT_FLOAT_FLOAT(operand1, operand2);
}
...
static nuitka_bool SLOT_nb_subtract_NBOOL_FLOAT_FLOAT(PyObject *operand1, PyObject *operand2) {
    CHECK_OBJECT(operand1);
    assert(PyFloat_CheckExact(operand1));
#if PYTHON_VERSION < 0x300
    assert(NEW_STYLE_NUMBER(operand1));
...
static nuitka_bool _BINARY_OPERATION_SUB_NBOOL_FLOAT_FLOAT(PyObject *operand1, PyObject *operand2) {
    ...
    return SLOT_nb_subtract_NBOOL_FLOAT_FLOAT(operand1, operand2);
}
...
static nuitka_bool _BINARY_OPERATION_SUB_NBOOL_OBJECT_OBJECT(PyObject *operand1, PyObject *operand2) {
    ...
    if (PyInt_CheckExact(operand1) && PyInt_CheckExact(operand2)) {
        ...
        result = t ? NUITKA_BOOL_TRUE : NUITKA_BOOL_FALSE;
        goto exit_result_ok;
