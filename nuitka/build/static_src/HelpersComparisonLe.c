...
static PyObject *COMPARE_LE_OBJECT_CLONG_LONG(long operand1, PyObject *operand2) {
...
PyObject *RICH_COMPARE_LE_OBJECT_INT_LONG(PyObject *operand1, PyObject *operand2) {

    return COMPARE_LE_OBJECT_CLONG_LONG(PyInt_AS_LONG(operand1), operand2);
}
#endif
...
static bool COMPARE_LE_CBOOL_CLONG_LONG(long operand1, PyObject *operand2) {
...
/* Code referring to "INT" corresponds to Python2 'int' and "LONG" to Python2 'long', Python3 'int'. */
bool RICH_COMPARE_LE_CBOOL_INT_LONG(PyObject *operand1, PyObject *operand2) {

    return COMPARE_LE_CBOOL_CLONG_LONG(PyInt_AS_LONG(operand1), operand2);
}
#endif
...
static nuitka_bool COMPARE_LE_NBOOL_CLONG_LONG(long operand1, PyObject *operand2) {
...
/* Code referring to "INT" corresponds to Python2 'int' and "LONG" to Python2 'long', Python3 'int'. */
nuitka_bool RICH_COMPARE_LE_NBOOL_INT_LONG(PyObject *operand1, PyObject *operand2) {

    return COMPARE_LE_NBOOL_CLONG_LONG(PyInt_AS_LONG(operand1), operand2);
}
#endif

#if PYTHON_VERSION < 0x300

static nuitka_bool COMPARE_LE_NBOOL_LONG_CLONG(PyObject *operand1, long operand2) {
    CHECK_OBJECT(operand1);
    assert(PyLong_CheckExact(operand1));
...
/* Code referring to "LONG" corresponds to Python2 'long', Python3 'int' and "INT" to Python2 'int'. */
nuitka_bool RICH_COMPARE_LE_NBOOL_LONG_INT(PyObject *operand1, PyObject *operand2) {

    return COMPARE_LE_NBOOL_LONG_CLONG(operand1, PyInt_AS_LONG(operand1));
}
#endif
...
#if PYTHON_VERSION < 0x300
static PyObject *COMPARE_LE_OBJECT_CLONG_INT(long operand1, PyObject *operand2) {
...
PyObject *RICH_COMPARE_LE_OBJECT_CLONG_INT(long operand1, PyObject *operand2) {

    return COMPARE_LE_OBJECT_CLONG_INT(operand1, operand2);
}
#endif
...
#if PYTHON_VERSION < 0x300
static bool COMPARE_LE_CBOOL_CLONG_INT(long operand1, PyObject *operand2) {
...
/* Code referring to "CLONG" corresponds to C platform long value and "INT" to Python2 'int'. */
bool RICH_COMPARE_LE_CBOOL_CLONG_INT(long operand1, PyObject *operand2) {

    return COMPARE_LE_CBOOL_CLONG_INT(operand1, operand2);
}
#endif

#if PYTHON_VERSION < 0x300
static nuitka_bool COMPARE_LE_NBOOL_INT_CLONG(PyObject *operand1, long operand2) {
    CHECK_OBJECT(operand1);
    assert(PyInt_CheckExact(operand1));
...
/* Code referring to "INT" corresponds to Python2 'int' and "CLONG" to C platform long value. */
nuitka_bool RICH_COMPARE_LE_NBOOL_INT_CLONG(PyObject *operand1, long operand2) {

    return COMPARE_LE_NBOOL_INT_CLONG(operand1, operand2);
}
#endif

#if PYTHON_VERSION < 0x300
static nuitka_bool COMPARE_LE_NBOOL_CLONG_INT(long operand1, PyObject *operand2) {
...
/* Code referring to "CLONG" corresponds to C platform long value and "INT" to Python2 'int'. */
nuitka_bool RICH_COMPARE_LE_NBOOL_CLONG_INT(long operand1, PyObject *operand2) {

    return COMPARE_LE_NBOOL_CLONG_INT(operand1, operand2);
}
#endif
...
static PyObject *COMPARE_LE_OBJECT_DIGIT_LONG(long operand1, PyObject *operand2) {
    ...
    if (false) {
        ...
        r = (Py_ssize_t)((operand1 == 0) ? 0 : ((operand1 < 0) ? -1 : 1)) - Py_SIZE(operand2_long_object) < 0;
    } else {
        Py_ssize_t i = (operand1 == 0 ? 0 : 1);
        r = true;
        while (--i >= 0) {
            if ((digit)Py_ABS(operand1) != operand2_long_object->ob_digit[i]) {
                r = (digit)Py_ABS(operand1) < operand2_long_object->ob_digit[i];
                if (operand1 < 0) {
                    r = !r;
                }
                break;
 ...
 * Python3 'int'. */
PyObject *RICH_COMPARE_LE_OBJECT_DIGIT_LONG(long operand1, PyObject *operand2) {

    return COMPARE_LE_OBJECT_DIGIT_LONG(operand1, operand2);
}
...
static bool COMPARE_LE_CBOOL_DIGIT_LONG(long operand1, PyObject *operand2) {
    assert(Py_ABS(operand1) < (1 << PyLong_SHIFT));
    CHECK_OBJECT(operand2);
    assert(PyLong_CheckExact(operand2));
...
/* Code referring to "DIGIT" corresponds to C platform digit value for long Python objects and "LONG" to Python2 'long',
 * Python3 'int'. */
bool RICH_COMPARE_LE_CBOOL_DIGIT_LONG(long operand1, PyObject *operand2) {

    return COMPARE_LE_CBOOL_DIGIT_LONG(operand1, operand2);
}

static nuitka_bool COMPARE_LE_NBOOL_LONG_DIGIT(PyObject *operand1, long operand2) {
    CHECK_OBJECT(operand1);
    assert(PyLong_CheckExact(operand1));
    assert(Py_ABS(operand2) < (1 << PyLong_SHIFT));
...
/* Code referring to "LONG" corresponds to Python2 'long', Python3 'int' and "DIGIT" to C platform digit value for long
 * Python objects. */
nuitka_bool RICH_COMPARE_LE_NBOOL_LONG_DIGIT(PyObject *operand1, long operand2) {

    return COMPARE_LE_NBOOL_LONG_DIGIT(operand1, operand2);
}

static nuitka_bool COMPARE_LE_NBOOL_DIGIT_LONG(long operand1, PyObject *operand2) {
    assert(Py_ABS(operand1) < (1 << PyLong_SHIFT));
    CHECK_OBJECT(operand2);
    assert(PyLong_CheckExact(operand2));
...
/* Code referring to "DIGIT" corresponds to C platform digit value for long Python objects and "LONG" to Python2 'long',
 * Python3 'int'. */
nuitka_bool RICH_COMPARE_LE_NBOOL_DIGIT_LONG(long operand1, PyObject *operand2) {

    return COMPARE_LE_NBOOL_DIGIT_LONG(operand1, operand2);
}
