...
static PyObject *Nuitka_Frame_clear(struct Nuitka_FrameObject *frame, PyObject *value) {
    assert(Nuitka_Frame_CheckExact((PyObject *)frame));
    CHECK_OBJECT((PyObject *)frame);
    assert(_PyObject_GC_IS_TRACKED(frame));
...
static PyObject *Nuitka_Frame_sizeof(struct Nuitka_FrameObject *frame, PyObject *value) {
    assert(Nuitka_Frame_CheckExact((PyObject *)frame));
    CHECK_OBJECT((PyObject *)frame);
    assert(_PyObject_GC_IS_TRACKED(frame));
