...
static PyObject *Nuitka_Function_reduce(struct Nuitka_FunctionObject *function, PyObject *value) {
    CHECK_OBJECT((PyObject *)function);
    assert(Nuitka_Function_Check((PyObject *)function));
    assert(_PyObject_GC_IS_TRACKED(function));
...
static PyObject *Nuitka_Function_clone(struct Nuitka_FunctionObject *function, PyObject *value) {
    CHECK_OBJECT((PyObject *)function);
    assert(Nuitka_Function_Check((PyObject *)function));
    assert(_PyObject_GC_IS_TRACKED(function));
