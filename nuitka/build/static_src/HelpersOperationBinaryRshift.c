...
static PyObject *SLOT_nb_rshift_OBJECT_LONG_LONG(PyObject *operand1, PyObject *operand2) {
...
static PyObject *_BINARY_OPERATION_RSHIFT_OBJECT_LONG_LONG(PyObject *operand1, PyObject *operand2) {
    ...
    return SLOT_nb_rshift_OBJECT_LONG_LONG(operand1, operand2);
}
...
static nuitka_bool SLOT_nb_rshift_NBOOL_LONG_LONG(PyObject *operand1, PyObject *operand2) {
    PyObject *x = PyLong_Type.tp_as_number->nb_rshift(operand1, operand2);
    assert(x != Py_NotImplemented);
    if (unlikely(x == NULL)) {
...
static nuitka_bool _BINARY_OPERATION_RSHIFT_NBOOL_LONG_LONG(PyObject *operand1, PyObject *operand2) {
    ...
    return SLOT_nb_rshift_NBOOL_LONG_LONG(operand1, operand2);
}
...
#if PYTHON_VERSION < 300
static PyObject *SLOT_nb_rshift_OBJECT_INT_INT(PyObject *operand1, PyObject *operand2) {
    CHECK_OBJECT(operand1);
...
static PyObject *_BINARY_OPERATION_RSHIFT_OBJECT_INT_INT(PyObject *operand1, PyObject *operand2) {
    ...
    return SLOT_nb_rshift_OBJECT_INT_INT(operand1, operand2);
}
...
#if PYTHON_VERSION < 300
static nuitka_bool SLOT_nb_rshift_NBOOL_INT_INT(PyObject *operand1, PyObject *operand2) {
    CHECK_OBJECT(operand1);
    assert(PyInt_CheckExact(operand1));
#if PYTHON_VERSION < 300
    assert(NEW_STYLE_NUMBER(operand1));
    ...
    if (a == 0 || b == 0) {
        ...
        if (a < 0) {
            return -1 != 0 ? NUITKA_BOOL_TRUE : NUITKA_BOOL_FALSE;
        } else {
            return 0 != 0 ? NUITKA_BOOL_TRUE : NUITKA_BOOL_FALSE;
        }
    } else {
        long r = Py_ARITHMETIC_RIGHT_SHIFT(long, a, b);
...
static nuitka_bool _BINARY_OPERATION_RSHIFT_NBOOL_INT_INT(PyObject *operand1, PyObject *operand2) {
    ...
    return SLOT_nb_rshift_NBOOL_INT_INT(operand1, operand2);
}
