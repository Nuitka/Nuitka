...
static PyObject *COMPARE_EQ_OBJECT_CLONG_LONG(long operand1, PyObject *operand2) {
...
PyObject *RICH_COMPARE_EQ_OBJECT_INT_LONG(PyObject *operand1, PyObject *operand2) {

    return COMPARE_EQ_OBJECT_CLONG_LONG(PyInt_AS_LONG(operand1), operand2);
}
#endif
...
static bool COMPARE_EQ_CBOOL_CLONG_LONG(long operand1, PyObject *operand2) {
...
/* Code referring to "INT" corresponds to Python2 'int' and "LONG" to Python2 'long', Python3 'int'. */
bool RICH_COMPARE_EQ_CBOOL_INT_LONG(PyObject *operand1, PyObject *operand2) {

    return COMPARE_EQ_CBOOL_CLONG_LONG(PyInt_AS_LONG(operand1), operand2);
}
#endif
...
static nuitka_bool COMPARE_EQ_NBOOL_CLONG_LONG(long operand1, PyObject *operand2) {
...
/* Code referring to "INT" corresponds to Python2 'int' and "LONG" to Python2 'long', Python3 'int'. */
nuitka_bool RICH_COMPARE_EQ_NBOOL_INT_LONG(PyObject *operand1, PyObject *operand2) {

    return COMPARE_EQ_NBOOL_CLONG_LONG(PyInt_AS_LONG(operand1), operand2);
}
#endif

#if PYTHON_VERSION < 0x300

static nuitka_bool COMPARE_EQ_NBOOL_LONG_CLONG(PyObject *operand1, long operand2) {
    CHECK_OBJECT(operand1);
    assert(PyLong_CheckExact(operand1));
...
/* Code referring to "LONG" corresponds to Python2 'long', Python3 'int' and "INT" to Python2 'int'. */
nuitka_bool RICH_COMPARE_EQ_NBOOL_LONG_INT(PyObject *operand1, PyObject *operand2) {

    return COMPARE_EQ_NBOOL_LONG_CLONG(operand1, PyInt_AS_LONG(operand1));
}
#endif
