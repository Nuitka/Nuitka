...
extern PyObject *BINARY_OPERATION_BITOR_LONG_INT(PyObject *operand1, PyObject *operand2);
#endif

#if PYTHON_VERSION < 300
/* Code referring to "INT" corresponds to Python2 'int' and "LONG" to Python2 'long', Python3 'int'. */
extern PyObject *BINARY_OPERATION_BITOR_INT_LONG(PyObject *operand1, PyObject *operand2);
#endif

/* Code referring to "OBJECT" corresponds to any Python object and "SET" to Python 'set'. */
extern PyObject *BINARY_OPERATION_BITOR_OBJECT_SET(PyObject *operand1, PyObject *operand2);

/* Code referring to "SET" corresponds to Python 'set' and "OBJECT" to any Python object. */
extern PyObject *BINARY_OPERATION_BITOR_SET_OBJECT(PyObject *operand1, PyObject *operand2);

/* Code referring to "SET" corresponds to Python 'set' and "SET" to Python 'set'. */
extern PyObject *BINARY_OPERATION_BITOR_SET_SET(PyObject *operand1, PyObject *operand2);

/* Code referring to "OBJECT" corresponds to any Python object and "LIST" to Python 'list'. */
extern PyObject *BINARY_OPERATION_BITOR_OBJECT_LIST(PyObject *operand1, PyObject *operand2);

/* Code referring to "LIST" corresponds to Python 'list' and "OBJECT" to any Python object. */
extern PyObject *BINARY_OPERATION_BITOR_LIST_OBJECT(PyObject *operand1, PyObject *operand2);

/* Code referring to "OBJECT" corresponds to any Python object and "TUPLE" to Python 'tuple'. */
extern PyObject *BINARY_OPERATION_BITOR_OBJECT_TUPLE(PyObject *operand1, PyObject *operand2);

/* Code referring to "TUPLE" corresponds to Python 'tuple' and "OBJECT" to any Python object. */
extern PyObject *BINARY_OPERATION_BITOR_TUPLE_OBJECT(PyObject *operand1, PyObject *operand2);
