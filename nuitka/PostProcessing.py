...
# It contains type stubs (for API) and implicit dependencies (for Nuitka
# dependency analysis in absence of source code) both.

# It lists the imports made and can be used by the tools that bundle
# libraries, including Nuitka itself. For instance
# standalone mode usage of the created library will need it.

# Then this also contains type information for values in the module,
# so IDEs will use this.

# Note: This is not Python source even if it looks so. Make it clear
# for now. This was decided by PEP 484 designers.
        """
        ...
        if stubgen is not None:
            ...
            stubs = "# Stub generation feature not available\n"
        ...
        if imported_module_names:
            ...
            contents += "# Modules used internally"
            contents += "\n".join(
