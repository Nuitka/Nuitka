...
static PyObject *module_constants[%(constants_count)d];
...
static void createModuleConstants(void) {
    loadConstantsBlob(&module_constants[0], "%(module_name)s", %(constants_count)d);
...
void checkModuleConstants_%(module_identifier)s(void) {
    ...
    checkConstantsBlob(&module_constants[0], "%(module_name)s", %(constants_count)d);
}
#endif
